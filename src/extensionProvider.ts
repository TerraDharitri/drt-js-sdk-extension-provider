...
declare global {
  interface Window {
    /**
      * @deprecated `numbatWallet` will be deprecated in future versions. Please use `dharitrWallet` instead for future compatibility.
    */
...
export class ExtensionProvider {
  ...
  async init(): Promise<boolean> {
    ...
    // Please use `dharitrWallet` instead for future compatibility.
